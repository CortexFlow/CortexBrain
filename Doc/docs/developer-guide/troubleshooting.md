...
This page resumes the most common issues you may encounter while running CortexBrain. For the initial setup, see the [Installation guide](../getting-started/installation.md).
